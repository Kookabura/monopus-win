...
Execute-BackupSQL -Databases 'bd_test' -BackupTempLocation C:\TMP\ -BackupSetsLocation D:\Backups\sql\crypto\ -Password "Az123456"

Backup-SqlDatabase -ServerInstance "HV-01" -Database "bd_test" -BackupFile "C:\TMP\bd_test.bac" 